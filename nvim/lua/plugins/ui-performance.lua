...
return {
  ...
  -- Disable or minimize noice.nvim functionality to reduce bugs and performance impact
  {
    ...
    opts = function(_, opts)
      ...
      -- Minimize command line enhancements
      opts.cmdline = {
        enabled = false,  -- Disable enhanced command line
      }
  ...
  -- Optimize treesitter for performance (disable expensive features)
  {
    "nvim-treesitter/nvim-treesitter",
    opts = function(_, opts)
      opts = opts or {}

      -- Disable expensive highlighting features on large files
      ...
      -- Disable expensive incremental selection
      opts.incremental_selection = {
        enable = false,
      }

      -- Optimize text objects (keep lightweight)
